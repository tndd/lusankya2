...
from tests.tests_service.factory.domain.dataset.chart import \
    factory_chart_repository
...
@pytest.fixture
def chart_repository(psql_client):
    yield factory_chart_repository(psql_client)
